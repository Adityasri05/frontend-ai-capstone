...
export default function HireviumPage() {
  return (
    <div className="w-full max-w-4xl mx-auto px-4 py-12 sm:py-16">
      ...
      <nav className="mb-6" aria-label="Breadcrumb">
        <ol className="flex items-center gap-2 text-xs font-mono text-brand-muted">
          ...
          <li aria-hidden="true">/</li>
          <li className="text-brand-accent font-semibold">HIREVIUM</li>
        </ol>
      </nav>
      ...
      <article className="p-8 sm:p-12 bg-brand-card border border-brand-border rounded-3xl shadow-brand-shadow-lg relative overflow-hidden">
        ...
        <p className="text-lg text-brand-muted font-medium mb-6">
          AI Hiring Intelligence Operating System
        </p>

        <p className="text-sm sm:text-base text-brand-muted leading-relaxed mb-8 max-w-2xl">
          Dual-sided technical vetting workspace designed with an Adaptive Difficulty Controller, live candidate speech transcript loops, and secure FastAPI backend proxying for Gemini LLM routing.
        </p>
        ...
        <div className="p-5 bg-brand-bg border border-brand-border rounded-2xl mb-8">
          ...
          <p className="text-xs text-brand-muted leading-relaxed">
            The full engineering breakdown, architecture diagrams, and real dashboard screenshots are being prepared as part of the AI Fluency portfolio track.
          </p>
        </div>
