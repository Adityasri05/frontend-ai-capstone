  ...
  return (
    <div className="w-full max-w-5xl mx-auto px-4 sm:px-6 py-8 sm:py-16 space-y-16 sm:space-y-24 overflow-x-hidden">
      ...
      <section id="work" className="scroll-mt-20">
        <div className="mb-8 sm:mb-10 pb-4 border-b border-brand-border">
        ...
        <div className="space-y-6 sm:space-y-8">
          {/* Project 1: HIREVIUM */}
          <article className="p-5 sm:p-8 bg-brand-card border border-brand-border hover:border-brand-accent/40 rounded-2xl transition-all duration-300 shadow-sm hover:shadow-brand-shadow-lg flex flex-col gap-5 sm:gap-6">
            <div className="flex flex-wrap items-center justify-between gap-2">
              <div>
                <span className="text-[10px] sm:text-[11px] uppercase font-mono font-bold text-brand-accent bg-brand-accent/10 px-2.5 py-1 rounded border border-brand-accent/20">
                  AI Hiring Intelligence OS
                </span>
              </div>
              <span className="text-[11px] sm:text-xs font-mono text-brand-muted">HRTech / Candidate Evaluation</span>
            </div>

            <div>
              <h3 className="text-lg sm:text-2xl font-bold text-brand-text mb-2 break-words">
          ...
          <article className="p-5 sm:p-8 bg-brand-card border border-brand-border hover:border-brand-accent/40 rounded-2xl transition-all duration-300 shadow-sm hover:shadow-brand-shadow-lg flex flex-col gap-5 sm:gap-6">
            <div className="flex flex-wrap items-center justify-between gap-2">
              ...
              <span className="text-[11px] sm:text-xs font-mono text-brand-muted">Enterprise Search / Vector RAG</span>
            </div>
          ...
          <article className="p-5 sm:p-8 bg-brand-card border border-brand-border hover:border-brand-accent/40 rounded-2xl transition-all duration-300 shadow-sm hover:shadow-brand-shadow-lg flex flex-col gap-5 sm:gap-6">
            <div className="flex flex-wrap items-center justify-between gap-2">
              ...
              <span className="text-[11px] sm:text-xs font-mono text-brand-muted">B2B SaaS / Agent Telemetry</span>
            </div>
      ...
      <section id="about" className="scroll-mt-20">
        <div className="p-6 sm:p-10 bg-brand-card/50 border border-brand-border rounded-2xl sm:rounded-3xl backdrop-blur-sm">
          <div className="inline-flex items-center gap-2 text-xs font-mono font-bold text-brand-accent uppercase tracking-wider mb-2">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-xs sm:text-sm text-brand-muted leading-relaxed">
      ...
      <section id="tech" className="scroll-mt-20">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
          {/* Frontend */}
          <div className="p-5 sm:p-6 bg-brand-card border border-brand-border rounded-2xl flex flex-col justify-between">
            <div>
              <div className="text-xs font-mono font-bold text-brand-accent uppercase mb-2">Frontend Engineering</div>
              <h3 className="text-base sm:text-lg font-bold text-brand-text mb-3">Client Architecture</h3>
          ...
          <div className="p-5 sm:p-6 bg-brand-card border border-brand-border rounded-2xl flex flex-col justify-between">
            <div>
              ...
              <h3 className="text-base sm:text-lg font-bold text-brand-text mb-3">API Proxies &amp; Validation</h3>
              <ul className="text-xs text-brand-muted space-y-2">
          ...
          <div className="p-5 sm:p-6 bg-brand-card border border-brand-border rounded-2xl flex flex-col justify-between">
            <div>
              ...
              <h3 className="text-base sm:text-lg font-bold text-brand-text mb-3">Model Integration</h3>
              <ul className="text-xs text-brand-muted space-y-2">
          ...
          <div className="p-5 sm:p-6 bg-brand-card border border-brand-border rounded-2xl flex flex-col justify-between">
            <div>
              ...
              <h3 className="text-base sm:text-lg font-bold text-brand-text mb-3">Testing &amp; Tooling</h3>
              <ul className="text-xs text-brand-muted space-y-2">
      ...
      <section id="cv" className="scroll-mt-20">
        <div className="p-6 sm:p-10 bg-brand-card border border-brand-border rounded-2xl sm:rounded-3xl">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
            <div>
              ...
              <div className="flex flex-wrap gap-3 sm:gap-4 items-center">
                <Link
                  href="/resume"
                  className="min-h-[44px] px-5 py-2.5 bg-brand-accent hover:bg-brand-primary-hover text-slate-100 font-semibold text-xs sm:text-sm rounded-xl transition-all shadow-md flex items-center justify-center gap-2 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-accent"
                >
                  <span>View Online Resume</span>
                  <span aria-hidden="true">→</span>
                </Link>
                <span className="min-h-[44px] px-4 py-2.5 bg-brand-bg text-brand-muted border border-brand-border text-xs rounded-xl font-mono flex items-center gap-2">
            ...
            <div className="p-5 sm:p-6 bg-brand-bg/80 border border-dashed border-brand-border rounded-2xl">
              ...
              <p className="text-[11px] text-brand-muted/80">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-brand-accent underline min-h-[44px] inline-flex items-center"
                >
      ...
      <section id="writing" className="scroll-mt-20">
        <div className="p-6 sm:p-8 bg-brand-card/40 border border-brand-border rounded-2xl sm:rounded-3xl">
          <div className="inline-flex items-center gap-2 text-xs font-mono font-bold text-brand-accent uppercase tracking-wider mb-2">
      ...
      <section id="contact" className="scroll-mt-20 py-10 sm:py-12 px-4 sm:px-8 bg-gradient-to-b from-brand-card to-brand-card/40 border border-brand-border rounded-2xl sm:rounded-3xl shadow-brand-shadow-lg">
        <div className="max-w-3xl mx-auto text-center space-y-3 sm:space-y-4 mb-8 sm:mb-10">
          <div className="inline-flex items-center gap-2 text-xs font-mono font-bold text-brand-accent uppercase tracking-wider">
            <span>Get in Touch</span>
          </div>
          <h2 className="text-2xl sm:text-4xl font-extrabold text-brand-text font-display break-words">
        ...
        <div className="mt-8 sm:mt-10 pt-6 sm:pt-8 border-t border-brand-border/60 text-center">
          ...
          <div className="flex flex-wrap justify-center gap-3 sm:gap-4 items-center">
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="min-h-[44px] min-w-[140px] px-6 py-2.5 bg-brand-accent hover:bg-brand-primary-hover text-slate-100 font-bold text-xs sm:text-sm rounded-xl transition-all duration-300 active:scale-95 shadow-md flex items-center justify-center gap-2 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-accent"
            >
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="min-h-[44px] min-w-[140px] px-6 py-2.5 bg-brand-bg hover:bg-brand-border text-brand-text border border-brand-border font-semibold text-xs sm:text-sm rounded-xl transition-all duration-300 active:scale-95 flex items-center justify-center gap-2 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-accent"
            >
